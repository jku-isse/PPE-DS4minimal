...
public class DataBlockProcessors {
	...
	public static class StreamBlockProcessor extends AbstractBlockProcessor {
		...
		public static Optional<Utils.ArtifactType> getTypeFromStream(BlockType block, ProcessingContext ctx) {
		...
		public static Optional<Utils.ArtifactType> getVarFromFieldAccessor(BlockType block, ProcessingContext ctx) {
...
//	}
	...
	public static Optional<Utils.ArtifactType> getArtifactTypeFromBlock(BlockType block, ProcessingContext ctx) {		
		switch(block.getType()) {
		case "artifact":
			// create artifact type from type field
			return Utils.getFieldValue(block.getField(), "Type").map(strType -> new Utils.ArtifactType(strType));			
		case "variables_get":			
